...
ZV_SHOTS = [('1763049596474', 141), ('1763049596500', 156)]
...
T = [
 ...
 ('150+ проектами', '15+ нішами'), ('ОПЫТ РАБОТЫ В НИШАХ', 'НІШ У РОБОТІ'),
 ('ГОРОДОВ И СТРАН. РАБОТАЕМ ПО ВСЕЙ РОССИИ И ЗАРУБЕЖОМ', 'РОКИ НА РИНКУ REELS-ПРОДАКШНУ'),
 ('РОЛИКОВ МИЛЛИОННИКОВ', 'РОЛИКІВ ІЗ 100+ ТИС. ПЕРЕГЛЯДІВ'),
 ...
 ('Команда с опытом работы в', 'Команда з досвідом роботи в'), ('50+ нишах', '15+ нішах'),
...
s = s.replace('let numberfinish = ["50","100","20"];', 'let numberfinish = ["15","3","10"];')
s = s.replace('"endDigit":"50"', '"endDigit":"15"').replace('"endDigit":"100"', '"endDigit":"3"').replace('"endDigit":"20"', '"endDigit":"10"')
print('counter fixed:', 'numberfinish = ["15","3","10"]' in s)
